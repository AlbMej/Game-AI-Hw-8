...
public class BoardScript : MonoBehaviour {
    ...
    public uint turnNumber;    // Technically, this would be better named plyNumber, two plies per turn
    bool gameStarted;
    bool gameEnded;
    ...
    void Awake() {
        ...
        if (isPlayerOneAI) {
            System.Type scriptType = System.Reflection.Assembly.GetExecutingAssembly().GetType("AlphaBetaAgent");
